...
export var View_OrderTableComponent0 = (function (_super) {
    ...
    View_OrderTableComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_20 = import3.createRenderElement(this.renderer, this._el_12, 'th', new import3.InlineArray2(2, 'colspan', '3'), null);
        ...
        this._el_33 = import3.createRenderElement(this.renderer, this._el_27, 'br', import3.EMPTY_INLINE_ARRAY, null);
...
var View_OrderTableComponent2 = (function (_super) {
    ...
    View_OrderTableComponent2.prototype.createInternal = function (rootSelector) {
        ...
        this._el_15 = import3.createRenderElement(this.renderer, this._el_1, 'th', import3.EMPTY_INLINE_ARRAY, null);
        this._text_16 = this.renderer.createText(this._el_15, 'Price', null);
        this._text_17 = this.renderer.createText(this._el_1, '\n                ', null);
        this._el_18 = import3.createRenderElement(this.renderer, this._el_1, 'td', import3.EMPTY_INLINE_ARRAY, null);
        this._text_19 = this.renderer.createText(this._el_18, '\n                    ', null);
        this._el_20 = import3.createRenderElement(this.renderer, this._el_18, 'button', new import3.InlineArray2(2, 'class', 'btn btn-warning'), null);
        this._text_21 = this.renderer.createText(this._el_20, '\n                        Ship\n                    ', null);
        this._text_22 = this.renderer.createText(this._el_18, '\n                    ', null);
        this._el_23 = import3.createRenderElement(this.renderer, this._el_18, 'button', new import3.InlineArray2(2, 'class', 'btn btn-danger'), null);
        ...
        this._vc_28 = new import12.ViewContainer(28, null, this, this._anchor_28);
        ...
        this._el_30 = import3.createRenderElement(this.renderer, null, 'tr', import3.EMPTY_INLINE_ARRAY, null);
        this._text_31 = this.renderer.createText(this._el_30, '\n                ', null);
        this._el_32 = import3.createRenderElement(this.renderer, this._el_30, 'td', new import3.InlineArray2(2, 'colspan', '3'), null);
        this._text_33 = this.renderer.createText(this._el_30, '\n                ', null);
        this._el_34 = import3.createRenderElement(this.renderer, this._el_30, 'th', import3.EMPTY_INLINE_ARRAY, null);
        this._text_35 = this.renderer.createText(this._el_34, 'Tolal ', null);
        this._text_36 = this.renderer.createText(this._el_30, '\n                ', null);
        this._el_37 = import3.createRenderElement(this.renderer, this._el_30, 'td', import3.EMPTY_INLINE_ARRAY, null);
        ...
        this.init(this._text_40, (this.renderer.directRenderer ? null : [
            this._text_0,
            this._el_1,
            this._text_2,
            this._el_3,
    ...
    View_OrderTableComponent2.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import26.NgFor) && (28 === requestNodeIndex))) {
    ...
    View_OrderTableComponent2.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_28_0_0 = this.context.$implicit.cart.lines;
        ...
        var currVal_44 = import3.inlineInterpolate(1, '', this.context.$implicit.name, '');
        if (import3.checkBinding(throwOnChange, this._expr_44, currVal_44)) {
            this.renderer.setText(this._text_4, currVal_44);
            this._expr_44 = currVal_44;
        }
        var currVal_45 = import3.inlineInterpolate(1, '', this.context.$implicit.zip, '');
        ...
        valUnwrapper.reset();
        var currVal_46 = import3.inlineInterpolate(1, '', valUnwrapper.unwrap(import3.castByValue(this._pipe_currency_0_1, this.parentView._pipe_currency_0.transform)(this.context.$implicit.cart.cartPrice, 'USD', true, '2.2-2')), '');
    ...
    View_OrderTableComponent2.prototype.createEmbeddedViewInternal = function (nodeIndex) {
        if ((nodeIndex == 28)) {
            return new View_OrderTableComponent3(this.viewUtils, this, 28, this._anchor_28, this._vc_28);
        }
        return null;
    };
    ...
    View_OrderTableComponent2.prototype.handleEvent_23 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
...
var View_OrderTableComponent3 = (function (_super) {
    ...
    View_OrderTableComponent3.prototype.detectChangesInternal = function (throwOnChange) {
        var valUnwrapper = new import6.ValueUnwrapper();
        var currVal_13 = import3.inlineInterpolate(1, '', this.context.$implicit.product.name, '');
        if (import3.checkBinding(throwOnChange, this._expr_13, currVal_13)) {
            this.renderer.setText(this._text_5, currVal_13);
            this._expr_13 = currVal_13;
        }
        var currVal_14 = import3.inlineInterpolate(1, '', this.context.$implicit.quantity, '');
        if (import3.checkBinding(throwOnChange, this._expr_14, currVal_14)) {
            this.renderer.setText(this._text_8, currVal_14);
            this._expr_14 = currVal_14;
        }
        valUnwrapper.reset();
        var currVal_15 = import3.inlineInterpolate(1, '', valUnwrapper.unwrap(import3.castByValue(this._pipe_currency_0_0, this.parentView.parentView._pipe_currency_0.transform)((this.context.$implicit.product.price * this.context.$implicit.quantity), 'USD', true, '2.2-2')), '');
