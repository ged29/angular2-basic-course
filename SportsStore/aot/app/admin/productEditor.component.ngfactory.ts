...
export class View_ProductEditorComponent0 extends import1.AppView<import0.ProductEditorComponent> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._el_0 = import3.createRenderElement(this.renderer,parentRenderNode,'div',new import3.InlineArray2(2,'class','bg-primary p-a-1 m-b-1'),(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_71:any = this.context.isEdit;
    ...
    const currVal_72:any = import3.inlineInterpolate(1,'',(this.context.isEdit? 'Edit': 'Create'),' Product');
    ...
    const currVal_73:any = this.context.isEdit;
