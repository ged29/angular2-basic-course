...
export class View_ProductTableComponent0 extends import1.AppView<import0.ProductTableComponent> {
  ...
  _text_27:any;
  _el_28:any;
  _RouterLink_28_3:import11.Wrapper_RouterLink;
  _text_29:any;
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._NgFor_24_6 = new import10.Wrapper_NgFor(this._vc_24.vcRef,this._TemplateRef_24_5,this.parentView.injectorGet(import14.IterableDiffers,this.parentIndex),this.ref);
    ...
    this._RouterLink_28_3 = new import11.Wrapper_RouterLink(this.parentView.injectorGet(import15.Router,this.parentIndex),this.parentView.injectorGet(import16.ActivatedRoute,this.parentIndex),this.parentView.injectorGet(import17.LocationStrategy,this.parentIndex));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import19.NgFor) && (24 === requestNodeIndex))) { return this._NgFor_24_6.context; }
    if (((token === import20.RouterLink) && ((28 <= requestNodeIndex) && (requestNodeIndex <= 29)))) { return this._RouterLink_28_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
