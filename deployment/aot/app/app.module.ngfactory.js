...
var AppModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RadioControlRegistry_36", {
        get: function () {
            if ((this.__RadioControlRegistry_36 == null)) {
                (this.__RadioControlRegistry_36 = new import24.RadioControlRegistry());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_BrowserXhr_37", {
        get: function () {
            if ((this.__BrowserXhr_37 == null)) {
                (this.__BrowserXhr_37 = new import25.BrowserXhr());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ResponseOptions_38", {
        get: function () {
            if ((this.__ResponseOptions_38 == null)) {
                (this.__ResponseOptions_38 = new import26.BaseResponseOptions());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_XHRBackend_40", {
        get: function () {
            if ((this.__XHRBackend_40 == null)) {
                (this.__XHRBackend_40 = new import27.XHRBackend(this._BrowserXhr_37, this._ResponseOptions_38, this._XSRFStrategy_39));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RequestOptions_41", {
        get: function () {
            if ((this.__RequestOptions_41 == null)) {
                (this.__RequestOptions_41 = new import28.BaseRequestOptions());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RestDataSource_43", {
        get: function () {
            if ((this.__RestDataSource_43 == null)) {
                (this.__RestDataSource_43 = new import29.RestDataSource(this._Http_42));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ProductRepository_44", {
        get: function () {
            if ((this.__ProductRepository_44 == null)) {
                (this.__ProductRepository_44 = new import30.ProductRepository(this._RestDataSource_43));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Cart_45", {
        get: function () {
            if ((this.__Cart_45 == null)) {
                (this.__Cart_45 = new import31.Cart());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Order_46", {
        get: function () {
            if ((this.__Order_46 == null)) {
                (this.__Order_46 = new import32.Order(this._Cart_45));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_OrderRepository_47", {
        get: function () {
            if ((this.__OrderRepository_47 == null)) {
                (this.__OrderRepository_47 = new import33.OrderRepository(this._RestDataSource_43));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_AuthService_48", {
        get: function () {
            if ((this.__AuthService_48 == null)) {
                (this.__AuthService_48 = new import34.AuthService(this._RestDataSource_43));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_UrlSerializer_49", {
        get: function () {
            if ((this.__UrlSerializer_49 == null)) {
                (this.__UrlSerializer_49 = new import35.DefaultUrlSerializer());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RouterOutletMap_50", {
        get: function () {
            if ((this.__RouterOutletMap_50 == null)) {
                (this.__RouterOutletMap_50 = new import36.RouterOutletMap());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocationStrategy_52", {
        get: function () {
            if ((this.__LocationStrategy_52 == null)) {
                (this.__LocationStrategy_52 = import7.provideLocationStrategy(this.parent.get(import57.PlatformLocation), this.parent.get(import58.APP_BASE_HREF, null), this._ROUTER_CONFIGURATION_51));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Location_53", {
        get: function () {
            if ((this.__Location_53 == null)) {
                (this.__Location_53 = new import37.Location(this._LocationStrategy_52));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_NgModuleFactoryLoader_54", {
        get: function () {
            if ((this.__NgModuleFactoryLoader_54 == null)) {
                (this.__NgModuleFactoryLoader_54 = new import38.SystemJsNgModuleLoader(this._Compiler_19, this.parent.get(import38.SystemJsNgModuleLoaderConfig, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Router_56", {
        get: function () {
            if ((this.__Router_56 == null)) {
                (this.__Router_56 = import7.setupRouter(this._ApplicationRef_18, this._UrlSerializer_49, this._RouterOutletMap_50, this._Location_53, this, this._NgModuleFactoryLoader_54, this._Compiler_19, this._ROUTES_55, this._ROUTER_CONFIGURATION_51, this.parent.get(import67.UrlHandlingStrategy, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_AuthGuard_57", {
        get: function () {
            if ((this.__AuthGuard_57 == null)) {
                (this.__AuthGuard_57 = new import39.AuthGuard(this._Router_56, this._AuthService_48));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ActivatedRoute_58", {
        get: function () {
            if ((this.__ActivatedRoute_58 == null)) {
                (this.__ActivatedRoute_58 = import7.rootRoute(this._Router_56));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_PreloadAllModules_62", {
        get: function () {
            if ((this.__PreloadAllModules_62 == null)) {
                (this.__PreloadAllModules_62 = new import40.PreloadAllModules());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ROUTER_INITIALIZER_63", {
        get: function () {
            if ((this.__ROUTER_INITIALIZER_63 == null)) {
                (this.__ROUTER_INITIALIZER_63 = import7.initialRouterNavigation(this._Router_56, this._ApplicationRef_18, this._RouterPreloader_61, this._ROUTER_CONFIGURATION_51));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_StoreFirstGuard_65", {
        get: function () {
            if ((this.__StoreFirstGuard_65 == null)) {
                (this.__StoreFirstGuard_65 = new import41.StoreFirstGuard(this._Router_56));
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ROUTER_FORROOT_GUARD_5 = import7.provideForRootGuard(this.parent.get(import68.Router, null));
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import29.RestDataSource)) {
            return this._RestDataSource_43;
        }
        if ((token === import30.ProductRepository)) {
            return this._ProductRepository_44;
        }
        if ((token === import31.Cart)) {
            return this._Cart_45;
        }
        if ((token === import32.Order)) {
            return this._Order_46;
        }
        if ((token === import33.OrderRepository)) {
            return this._OrderRepository_47;
        }
        ...
        if ((token === import41.StoreFirstGuard)) {
            return this._StoreFirstGuard_65;
        }
