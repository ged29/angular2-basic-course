...
var CategoryCountComponent = (function () {
    function CategoryCountComponent(model, keyValueDiffers, changeDetectorRef) {
        this.model = model;
    ...
    CategoryCountComponent.prototype.updateCount = function () {
        this.count = this.model
            .getProducts()
            .map(function (p) { return p.category; })
            .filter(function (category, index, arr) { return arr.indexOf(category) === index; }).length;
    };
