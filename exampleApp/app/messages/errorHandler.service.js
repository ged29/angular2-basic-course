...
var MessageErrorHandler = (function () {
    ...
    MessageErrorHandler.prototype.handleError = function (error) {
        var _this = this;
        var text = error instanceof Error ? error.message : error.toString();
        setTimeout(function () { return _this.messageService.reportMessage(new message_model_1.Message(text, true)); }, 0);
    };
